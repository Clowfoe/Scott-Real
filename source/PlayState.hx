...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
			...
			case 'scott':
				{
						defaultCamZoom = 0.9;
						curStage = 'scott';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('ScottBG'));
						bg.antialiasing = true;
						bg.scrollFactor.set(1, 1);
						bg.active = false;
						add(bg);
	
						var stageFront:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('scottfloor'));
						stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
			...
			case 'scott2':
				{
						...
						var bg2:FlxSprite = new FlxSprite(190, -100);
						bg2.frames = Paths.getSparrowAtlas('RPGBgChars');
						bg2.animation.addByPrefix('Vegans', 'Vegans', 24);
						bg2.animation.play('Vegans');
						bg2.antialiasing = true;
						add(bg2);

						var ass:FlxSprite = new FlxSprite(100, 100);
						ass.frames = Paths.getSparrowAtlas('BorderBump');
						ass.animation.addByPrefix('Border Bump', 'Border Bump', 24);
						ass.scrollFactor.set(1, 1);
						ass.scale.set(1.7, 1.7);
				//		add(ass);
			...
			case 'scott3':
				{
						...
						var bg2:FlxSprite = new FlxSprite(-210, -100);
						bg2.frames = Paths.getSparrowAtlas('BreakoutBgChars');
						bg2.animation.addByPrefix('All Friends', 'All Friends', 24);
						bg2.animation.play('All Friends');
						bg2.antialiasing = true;
						add(bg2);
			...
			case 'scott4':
				{
						...
						var spinny:FlxSprite = new FlxSprite(-300, -300);
						spinny.frames = Paths.getSparrowAtlas('Brain_bg');
						spinny.animation.addByPrefix('Background instance 1', 'Background instance 1', 24);
						spinny.animation.play('Background instance 1');
						spinny.scrollFactor.set(0.8, 0.8);
						spinny.scale.set(2, 2);
						add(spinny);


						var bg:FlxSprite = new FlxSprite(-600, -700).loadGraphic(Paths.image('floorblue'));
						bg.antialiasing = true;
						bg.scrollFactor.set(1, 1);
						bg.active = false;
						add(bg);
						...
						ass.frames = Paths.getSparrowAtlas('BorderBump');
						ass.animation.addByPrefix('Border Bump', 'Border Bump', 24);
						ass.animation.play('Border Bump');
						ass.scrollFactor.set(1, 1);
						ass.scale.set(1.7, 1.7);
					//	add(ass);
		...
		ass = new FlxSprite(0, 0).loadGraphic(Paths.image('mail'));
		ass.scrollFactor.set();
		ass.screenCenter();
		add(ass);

		var ass2:FlxSprite = new FlxSprite(0, 0);
		ass2.frames = Paths.getSparrowAtlas('BorderBump');
		ass2.animation.addByPrefix('Border Bump', 'Border Bump', 24);
